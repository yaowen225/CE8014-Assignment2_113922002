...
async def main():
    ...
    write_mcp_server = StdioServerParams(
        command="npx", 
        args=["@modelcontextprotocol/server-filesystem", "C:/Users/yaowe/Desktop/Personal/code/CE8014/Assignment2_113922002/all_project_file"]
    )
    ...
    selector_model_client = OpenAIChatCompletionClient(model="gpt-4o")
